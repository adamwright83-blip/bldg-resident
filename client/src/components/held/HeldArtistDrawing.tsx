...
const COMPOSITE_PATHS: Record<string, HeldDrawing> = {
  ...
  dry_cleaning: {
    id: "dry_cleaning",
    main: "M332 89 C329 78 331 66 341 60 C352 53 366 59 368 71 C370 82 362 91 350 99 L350 108",
    details: [
      "M205 140 L292 99 C306 92 319 88 332 89 C347 90 360 96 373 105 L455 142",
      "M34 210 C72 212 109 211 137 205 C151 202 158 191 164 174 C171 154 185 145 205 140 L259 123 C272 119 282 121 291 132 L315 158 C323 167 336 167 345 157 L370 129 C378 120 389 117 402 122 L455 142 C475 149 489 159 497 178 C504 195 515 204 533 208 C557 213 584 213 612 211",
      "M259 123 C267 142 280 155 299 162 C311 167 317 177 317 194 L314 221 M402 122 C394 142 381 156 363 164 C351 169 346 181 346 198 L347 221",
      "M259 123 C277 133 295 139 315 140 L332 158 L349 140 C368 138 385 132 402 122",
      "M332 158 L332 220 M327 177 L337 177 M327 193 L337 193 M327 209 L337 209",
    ],
  },
