...
const COMPOSITE_PATHS: Record<string, HeldDrawing> = {
  ...
  // FOLDED SHIRT — collar, shoulders, sleeves, hem. Picasso rule: the collar
  // line stops short of where it began, leaving the breathing gap.
  laundry_pickup: {
    id: "laundry_pickup",
    main: "M150 110 C150 110 138 100 130 110 C116 126 108 150 124 156 C140 162 148 150 150 136 C150 160 150 196 150 200 C150 210 160 214 170 214 L262 214 C272 214 282 210 282 200 C282 196 282 160 282 136 C284 150 292 162 308 156 C324 150 316 126 302 110 C294 100 282 110 282 110 M282 110 C272 100 250 100 240 112 C232 122 200 122 192 112 C184 102 170 101 161 106",
  },
